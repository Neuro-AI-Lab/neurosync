...
**Cross-refs:** `CVR-017`, `REV-039`, `REV-038`, `EXP-020`, `ISS-F2V-027` (sibling — item-8 is one instance of this pattern), `PLAN-2026-W29-A`, `ADR-033`
