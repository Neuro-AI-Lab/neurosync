...
**Status:** open — deferred (blocked on the v1 item-bank user decision)

**Owning gate:** clinical-validator

**Cross-refs:** `CVR-015`, `REV-037`, `REV-036`, `EXP-019`, `PLAN-2026-W28-V`, `ADR-032`
