...
moved to `_archive/simulation_results/` on 2026-07-11 (`PLAN-2026-W28-Q` W1, answer #8a /
directive 4). The 32 input-asset fixtures (22 mp3 + 4 OCR PDF + 6 `tts_scripts/` files)
relocated instead to `apps/ai-server/tests/fixtures/` (`audio/`, `ocr/`, `tts_scripts/`).

See `_archive/README.md` for the full manifest of what moved and why.
